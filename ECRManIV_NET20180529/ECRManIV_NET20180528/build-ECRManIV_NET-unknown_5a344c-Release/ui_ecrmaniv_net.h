...
public:
    ...
    void setupUi(QWidget *ECRManIV_NET)
    {
        ...
        ticket->setGeometry(QRect(60, 430, 100, 100));
        ticket->setStyleSheet(QString::fromUtf8("border-image: url(:/images/icons/tailer.png);"));
        TICKET = new QLabel(menu);
        TICKET->setObjectName(QString::fromUtf8("TICKET"));
        TICKET->setGeometry(QRect(80, 540, 61, 21));
        TICKET->setLayoutDirection(Qt::LeftToRight);
    ...
    void retranslateUi(QWidget *ECRManIV_NET)
    {
        ...
        TICKET->setText(QApplication::translate("ECRManIV_NET", "TICKET", 0, QApplication::UnicodeUTF8));
