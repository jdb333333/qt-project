...
void reportDialog::creatreport(QString suffixname, char Idx, char * Titel, char Type)
{
	...
	if(Idx & CLERKDAILY)
	{
		...
		{
        	memset(str, 0, TXTWIDTH);
            strcpy(str, QString("CLERK %1").arg(clerknum).toLocal8Bit().data());
...
void reportDialog::on_TIMEZONE_clicked()
{
        memset(reporttxt, 0, sizeof(reporttxt));
        ui->reportedit->clear();
...
void reportDialog::on_PERIODPLU_clicked()
{
        memset(reporttxt, 0, sizeof(reporttxt));
        ui->reportedit->clear();
...
void reportDialog::on_DAILYREPORT_clicked()
{
        memset(reporttxt, 0, sizeof(reporttxt));
        ui->reportedit->clear();
...
void reportDialog::on_CLERKDAILY_clicked()
{
        memset(reporttxt, 0, sizeof(reporttxt));
        ui->reportedit->clear();
