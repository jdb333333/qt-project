...
public:
    ...
    void setupUi(QWidget *ECRManIV_NET)
    {
        ...
        actionMODI = new QAction(ECRManIV_NET);
        actionMODI->setObjectName(QString::fromUtf8("actionMODI"));
        ...
        tableWidget_2->setGeometry(QRect(0, 0, 181, 601));
    ...
    void retranslateUi(QWidget *ECRManIV_NET)
    {
        ...
        actionMODI->setText(QApplication::translate("ECRManIV_NET", "MODI", 0, QApplication::UnicodeUTF8));
