...
void itemreport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData itemreport::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject itemreport::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_itemreport,
      qt_meta_data_itemreport, &staticMetaObjectExtraData }
};
